 ...
 *
 * User requirement: Thread.sleep(10000) applied after each page load
 */

//TODO move validations to @AfterTest when Zafira adds support for annotations
public class MultiEventValidationServiceWebTestWithPause extends MultiEventBaseWebTest {
