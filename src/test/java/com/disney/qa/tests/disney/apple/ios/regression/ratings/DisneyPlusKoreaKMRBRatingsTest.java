...
public class DisneyPlusKoreaKMRBRatingsTest extends DisneyPlusRatingsBase {
    ...
    @Test(description = "Ratings-South Korea 12+ KMRB", groups = {"NonUS-Ratings"})
    ...
    @Test(description = "Ratings-South Korea 15+ KMRB", groups = {"NonUS-Ratings"})
    ...
    @Test(description = "Ratings-South Korea 18+ KMRB", groups = {"NonUS-Ratings"})
    ...
    @Test(description = "Ratings-South Korea 19+ KMRB", groups = {"NonUS-Ratings"})
