...
public class DisneyPlusDetailsTest extends DisneyBaseTest {
    ...
    @Test(description = "Series/Movies Detail Page > User taps add to watchlist", groups = {TestGroup.DETAILSPAGE, TestGroup.PRE_CONFIGURATION})
    ...
    @Test(description = "Details Page - IMAX Enhanced - Badges", groups = {TestGroup.DETAILSPAGE, TestGroup.PRE_CONFIGURATION}, enabled = false)
    ...
    @Test(description = "Series/Movies Detail Page > Negative Stereotype Advisory Expansion", groups = {TestGroup.DETAILSPAGE, TestGroup.PRE_CONFIGURATION})
    ...
    @Test(description = "Maturity Rating Restriction on Detail Page", groups = {TestGroup.DETAILSPAGE, TestGroup.PRE_CONFIGURATION}, enabled = false)
    ...
    @Test(description = "Details Page - IMAX Enhanced - Versions Tab", groups = {TestGroup.DETAILSPAGE, TestGroup.PRE_CONFIGURATION}, enabled = false)
    ...
    @Test(description = "Details Page - ShopDisney - Feature Area of Details Page", groups = {TestGroup.DETAILSPAGE, TestGroup.PRE_CONFIGURATION})
    ...
    @Test(description = "Details Page - ShopDisney - Shop Tab - Primary Profile (Ad Tier & Non Ad Tier)", dataProvider = "disneyPlanTypes", groups = {TestGroup.DETAILSPAGE, TestGroup.PRE_CONFIGURATION})
    ...
    @Test(description = "Details Page - Bookmarks - Visual Progress Bar - Update after user watches content", groups = {TestGroup.DETAILSPAGE, TestGroup.PRE_CONFIGURATION})
