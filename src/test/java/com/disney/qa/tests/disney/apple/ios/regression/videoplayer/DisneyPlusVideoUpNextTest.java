...
public class DisneyPlusVideoUpNextTest  extends DisneyBaseTest {
    ...
    @Test(description = "Verify Up Next UI", groups = {"VideoPlayer", TestGroup.PRE_CONFIGURATION})
    ...
    @Test(description = "User Taps play icon", groups = {"VideoPlayer", TestGroup.PRE_CONFIGURATION }, enabled = false)
    @Maintainer("gkrishna1")
    ...
    @Test(description = "User Taps See All Episodes", groups = {"VideoPlayer", TestGroup.PRE_CONFIGURATION }, enabled = false)
    @Maintainer("gkrishna1")
    ...
    @Test(description = "User allows autoplay to occur", groups = {"VideoPlayer", TestGroup.PRE_CONFIGURATION }, enabled = false)
    @Maintainer("gkrishna1")
    ...
    @Test(description = "Up Next Logic -Extra content", groups = {"VideoPlayer", TestGroup.PRE_CONFIGURATION })
    @Maintainer("gkrishna1")
    ...
    @Test(description = "Up Next Behavior when app gets backgrounded", groups = {"VideoPlayer", TestGroup.PRE_CONFIGURATION}, dataProvider = "autoplay-state", enabled = false)
    @Maintainer("gkrishna1")
    ...
    @TestLabel(name = ZEBRUNNER_XRAY_TEST_KEY, value = {"XMOBQA-67656"})
    @Test(description = "Autoplay does not autoplay if disabled", groups = {"VideoPlayer", TestGroup.PRE_CONFIGURATION }, enabled = false)
    @Maintainer("gkrishna1")
