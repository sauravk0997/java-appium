...
public class DisneyPlusRalphProfileTest extends DisneyBaseTest {
    ...
    public void testRalphEditProfileAndSelectRatingDifferentFromRecommended() {
        ...
        sa.assertTrue(contentRating.getStaticTextViewValueContains("Learn More").isPresent(),"Learn More link is not present");
        ...
        if (R.CONFIG.get(DEVICE_TYPE).equals(TABLET)) {
            contentRating.scrollToItem("R");
            contentRating.scrollToItem(contentRating.getStaticTextByLabelContains(recommendedContentRatingByAge).getText());
