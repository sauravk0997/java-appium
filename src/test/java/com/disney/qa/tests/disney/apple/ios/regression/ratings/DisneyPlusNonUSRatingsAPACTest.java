...
import static com.disney.qa.common.constant.RatingConstant.Country.JP;
...
public class DisneyPlusNonUSRatingsAPACTest extends DisneyPlusRatingsBase {
    ...
    public void verifyRatingSystemAPACG() {
        ratingsSetup(G.getContentRating(), JAPAN_LANG, JP.toString());
    ...
    public void verifyRatingSystemAPACPG() {
        ratingsSetup(PG.getContentRating(), JAPAN_LANG, JP.toString());
    ...
    public void verifyRatingSystemAPAC12() {
        ratingsSetup(TWELVE_PLUS.getContentRating(), JAPAN_LANG, JP.toString());
