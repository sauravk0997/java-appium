...
public class DisneyPlusVideoAudioSubtitlesMenuTest extends DisneyBaseTest {
    ...
    @Test(description = "Verify Menu, Languages and UI", groups = {"VideoPlayer, PlayerAudioSubtitles", TestGroup.PRE_CONFIGURATION})
    ...
    @Test(description = "Verify Menu, Languages and UI(change options)", groups = {"VideoPlayer", TestGroup.PRE_CONFIGURATION})
    ...
    @Test(description = "Audio & Subtitles Menu - Chinese Language Support", groups = {"VideoPlayer", TestGroup.PRE_CONFIGURATION})
    ...
    @Test(description = "Video Player Controls - Audio & Subtitles Menu - Backgrounding the App from the player", groups = {"VideoPlayer", TestGroup.PRE_CONFIGURATION}, enabled = false)
    ...
    @Test(description = "Video Player Controls - Audio & Subtitles Menu - English Audio Descriptive Language Track", groups = {"VideoPlayer", TestGroup.PRE_CONFIGURATION})
