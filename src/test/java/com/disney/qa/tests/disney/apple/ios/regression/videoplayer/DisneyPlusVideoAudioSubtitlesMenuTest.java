...
public class DisneyPlusVideoAudioSubtitlesMenuTest extends DisneyBaseTest {
    ...
    @Test(description = "Verify Menu, Languages and UI", groups = {TestGroup.VIDEOPLAYER, "PlayerAudioSubtitles", TestGroup.PRE_CONFIGURATION})
    ...
    @Test(description = "Verify Menu, Languages and UI(change options)", groups = {TestGroup.VIDEOPLAYER, TestGroup.PRE_CONFIGURATION})
    ...
    @Test(description = "Audio & Subtitles Menu - Chinese Language Support", groups = {TestGroup.VIDEOPLAYER, TestGroup.PRE_CONFIGURATION})
    ...
    @Test(description = "Video Player Controls - Audio & Subtitles Menu - Backgrounding the App from the player", groups = {TestGroup.VIDEOPLAYER, TestGroup.PRE_CONFIGURATION}, enabled = false)
    ...
    @Test(description = "Video Player Controls - Audio & Subtitles Menu - English Audio Descriptive Language Track", groups = {TestGroup.VIDEOPLAYER, TestGroup.PRE_CONFIGURATION})
