...
public class DisneyPlusMoreMenuAppSettingsTest extends DisneyBaseTest {
    ...
    public void verifyCellularDataUsagePageUI() {
        ...
        ExtendedWebElement automatic = disneyPlusMoreMenuIOSPageBase.getTypeCellLabelContains(automaticLabel);
        ...
        ExtendedWebElement saveData = disneyPlusMoreMenuIOSPageBase.getTypeCellLabelContains(saveDataLabel);
...
//        new IOSUtils().clickNearElement(disneyPlusMoreMenuIOSPageBase.getDynamicXpathContainsName(saveDataLabel), .5, 30);
        System.out.println(automatic.isElementPresent());
        System.out.println(automatic.getAttribute(VALUE).equals(UNCHECKED));
        System.out.println(getDriver().getPageSource());
