...
public class DisneyPlusLATAMRatingsTest extends DisneyPlusRatingsBase {
    ...
    public void verifyRatingSystemLATAM0() {
        ratingsSetup(DISNEY_PLUS_PREMIUM_YEARLY, ZERO_PLUS.getContentRating(), getCountry());
    ...
    public void verifyRatingSystemLATAM7() {
        ratingsSetup(DISNEY_PLUS_PREMIUM_YEARLY, SEVEN_PLUS.getContentRating(), getCountry());
    ...
    public void verifyRatingSystemLATAM10() {
        ratingsSetup(DISNEY_PLUS_PREMIUM_YEARLY, TEN_PLUS.getContentRating(), getCountry());
    ...
    public void verifyRatingSystemLATAM12() {
        ratingsSetup(DISNEY_PLUS_PREMIUM_YEARLY, TWELVE_PLUS.getContentRating(), getCountry());
    ...
    public void verifyRatingSystemLATAM13() {
        ratingsSetup(DISNEY_PLUS_PREMIUM_YEARLY, THIRTEEN_PLUS.getContentRating(), getCountry());
    ...
    public void verifyRatingSystemLATAM14() {
        ratingsSetup(DISNEY_PLUS_PREMIUM_YEARLY, FOURTEEN_PLUS.getContentRating(), getCountry());
    ...
    public void verifyRatingSystemLATAM16() {
        ratingsSetup(DISNEY_PLUS_PREMIUM_YEARLY, SIXTEEN_PLUS.getContentRating(), getCountry());
