...
public class DisneyPlusVideoPlayerControlTest extends DisneyBaseTest {
    ...
    @Test(description = "Video Player > Title and Back Button to Close", groups = {"VideoPlayer", TestGroup.PRE_CONFIGURATION}, dataProvider = "contentType")
    ...
    @Test(description = " Video Player > Tap on screen to Rewind", groups = {"VideoPlayer", TestGroup.PRE_CONFIGURATION})
    ...
    @TestLabel(name = ZEBRUNNER_XRAY_TEST_KEY, value = {"XMOBQA-66529"})
    @Test(description = " Video Player > Tap on screen to Forward", groups = {"VideoPlayer", TestGroup.PRE_CONFIGURATION}, enabled = false)
    @Maintainer("gkrishna1")
    ...
    @Test(description = "Video Player > User taps to close Video Player from Deeplink", groups = {"VideoPlayer", TestGroup.PRE_CONFIGURATION}, enabled = false)
    @Maintainer("gkrishna1")
    ...
    @Test(description = "Video Player > Player Controls UI - Confirm Program Title for Movies / Series / Extras", groups = {"VideoPlayer", TestGroup.PRE_CONFIGURATION}, dataProvider = "contentType", enabled = false)
    @Maintainer("gkrishna1")
    ...
    @Test(description = "Video Player > Player Controls UI", groups = {"VideoPlayer", TestGroup.PRE_CONFIGURATION}, enabled = false)
    @Maintainer("gkrishna1")
    ...
    @Test(description = "Hulk - Hulu Video Player - Service Attribution", dataProvider = "userType", groups = {"VideoPlayer", TestGroup.PRE_CONFIGURATION})
    ...
    @Test(description = "VOD Player - RW & FW - Play State", groups = {"VideoPlayer", TestGroup.PRE_CONFIGURATION})
    ...
    @Test(description = "VOD Player Controls - Scrubber Elements", groups = {"VideoPlayer", TestGroup.PRE_CONFIGURATION})
