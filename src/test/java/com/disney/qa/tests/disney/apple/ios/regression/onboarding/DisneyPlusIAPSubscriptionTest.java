...
public class DisneyPlusIAPSubscriptionTest extends DisneyBaseTest {
    ...
    public void verifyOnboardingStepperUS() {
        ...
        sa.assertTrue(createPasswordPage.getStepTitleText().equals(disneyPlusSignUpIOSPageBase.getStepperDictValue("1","3")), "Onboarding stepper title '1 OF 5' is not as expected");
        ...
        sa.assertTrue(createPasswordPage.getStepTitleText().equals(disneyPlusSignUpIOSPageBase.getStepperDictValue("2","3")), "Onboarding stepper title '2 OF 5' is not as expected");
