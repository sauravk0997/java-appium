...
public class DisneyPlusOFLCRatingsTest extends DisneyPlusRatingsBase {
    ...
    public void verifyNewZealandOFLCRating13() {
        ratingsSetup(THIRTEEN.getContentRating(), getLanguage(), getCountry());
    ...
    public void verifyNewZealandOFLCRatingRP13() {
        ratingsSetup(RP13.getContentRating(), getLanguage(), getCountry());
    ...
    public void verifyNewZealandOFLCRatingR15() {
        ratingsSetup(R15.getContentRating(), getLanguage(), getCountry());
    ...
    public void verifyNewZealandOFLCRatingR16() {
        ratingsSetup(R16.getContentRating(), getLanguage(), getCountry());
    ...
    public void verifyNewZealandOFLCRatingRP16() {
        ratingsSetup(RP16.getContentRating(), getLanguage(), getCountry());
    ...
    public void verifyNewZealandOFLCRatingR18() {
        ratingsSetup(R18.getContentRating(), getLanguage(), getCountry());
    ...
    public void verifyNewZealandOFLCRatingRP18() {
        ratingsSetup(RP18.getContentRating(), getLanguage(), getCountry());
