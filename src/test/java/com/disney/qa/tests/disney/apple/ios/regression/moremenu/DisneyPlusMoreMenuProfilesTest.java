...
public class DisneyPlusMoreMenuProfilesTest extends DisneyBaseTest {
    ...
    @Maintainer("gkrishna1")
    @TestLabel(name = ZEBRUNNER_XRAY_TEST_KEY, value = {"XMOBQA-69511","XMOBQA-75395","XMOBQA-75396"})
    ...
    public void verifyEditProfileChangeAvatar() {
        ...
        //validate scrolling
        sa.assertTrue(chooseAvatar.isCollectionViewScrollableHorizontally(9, chooseAvatar.getRandomAvatarCollectionNum()), "Not able to horizontally scroll in collection.");
