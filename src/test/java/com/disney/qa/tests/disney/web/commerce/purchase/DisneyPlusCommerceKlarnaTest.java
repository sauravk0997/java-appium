...
public class DisneyPlusCommerceKlarnaTest extends DisneyPlusBaseTest {

    ThreadLocal<DisneyAccount> disneyAccount = new ThreadLocal<com.disney.qa.api.pojos.DisneyAccount>();
    private String localeToUse = "DE";

    private String paymentType = "klarna";
    ...
    @Test(description = "Monthly Subscription - Klarna", groups = {"DE", "US",TestGroup.DISNEY_SMOKE, TestGroup.DISNEY_COMMERCE_SMOKE})
    ...
    @Test(description = "Annual Subscription - Klarna", groups = {"DE","US", TestGroup.DISNEY_SMOKE, TestGroup.DISNEY_COMMERCE_SMOKE})
    public void annual() throws URISyntaxException, JSONException, MalformedURLException {
        skipTestByEnv(PROD);
        skipTestByEnv(BETA);

        setZebrunnerXrayLabels(new ZebrunnerXrayLabels(DIS, DE, "XWEBQAP-52943"));
    ...
    @Test(description = "Monthly Subscription - Klarna - Ensure Failure", groups = "DE")
    public void monthlyKlarnaUnavailable() throws URISyntaxException, JSONException, MalformedURLException {
        skipTestByEnv(PROD);
        skipTestByEnv(BETA);
