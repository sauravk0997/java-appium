...
public class DisneyPlusDetailsSeriesTest extends DisneyBaseTest {
    ...
    @Test(description = "Series Detail: attempt download season with more than 20 episodes", groups = {"DetailsPage", TestGroup.PRE_CONFIGURATION})
    ...
    @Test(description = "Series Detail Page > User Taps Seasons", groups = {"DetailsPage", TestGroup.PRE_CONFIGURATION})
    ...
    @Test(description = "Series Detail Page > User taps checkmark to remove watchlist", groups = {"DetailsPage", TestGroup.PRE_CONFIGURATION}, enabled = false)
    ...
    @Test(description = "Series Details: Verify Details Tab Metadata", groups = {"DetailsPage", TestGroup.PRE_CONFIGURATION})
    ...
    @Test(description = "Series Details - Verify UI Elements", groups = {"DetailsPage", TestGroup.PRE_CONFIGURATION})
    ...
    @Test(description = "Series Details - Deeplink", groups = {"Deeplinks", TestGroup.PRE_CONFIGURATION})
    ...
    @Test(description = "Asset Detail Page > User taps Share Button", groups = {"DetailsPage", TestGroup.PRE_CONFIGURATION})
    ...
    @Test(description = "Series Detail Page > User taps on Suggested tab", groups = {"DetailsPage", TestGroup.PRE_CONFIGURATION})
    ...
    @Test(description = "Series Details verify extras tab", groups = {"DetailsPage", TestGroup.PRE_CONFIGURATION})
    ...
    @Test(description = "Details Page - Resume State - Series - Episodes Tab", groups = {"DetailsPage", TestGroup.PRE_CONFIGURATION}, enabled = false)
    ...
    @Test(description = "Series Details verify resume behavior", groups = {"DetailsPage", TestGroup.PRE_CONFIGURATION}, enabled = false)
    ...
    @Test(description = "Details Page - Resume State - Series", groups = {"DetailsPage", TestGroup.PRE_CONFIGURATION})
    ...
    @Test(description = "Series Details verify playback behavior", groups = {"DetailsPage", TestGroup.PRE_CONFIGURATION})
    ...
    @Test(description = "Series Details Page - Featured Episode Metadata", groups = {"DetailsPage", TestGroup.PRE_CONFIGURATION}, enabled = false)
