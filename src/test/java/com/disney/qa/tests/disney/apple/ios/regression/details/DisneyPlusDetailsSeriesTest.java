...
public class DisneyPlusDetailsSeriesTest extends DisneyBaseTest {
    ...
    public void verifyComingSoonSeriesBehavior() {
        ...
        String entityID = R.TESTDATA.get("disney_prod_series_your_friendly_neighborhood_spider_man_entity_id");
        String deeplink = R.TESTDATA.get("disney_prod_series_your_friendly_neighborhood_spider_man_deeplink");
        ...
        String url = searchPage.getClipboardContentBySearchInput().split("\\?")[0];
        String expectedUrl = R.TESTDATA.get("disney_prod_series_your_friendly_neighborhood_spider_man_deeplink");
