...
public class DisneyPlusMPAAandTVPGRatingsTest extends DisneyPlusRatingsBase {
    ...
    public void verifyRatingSystemTV_Y() {
        ratingsSetup(TV_Y.getContentRating(), getCountry());
        handleOneTrustPopUp();
    ...
    public void verifyRatingSystemTV_Y7() {
        ratingsSetup(TV_Y7.getContentRating(), getCountry());
        handleOneTrustPopUp();
    ...
    public void verifyRatingSystemTV_Y7_FV() {
        ratingsSetup(TV_Y7_FV.getContentRating(), getCountry());
        handleOneTrustPopUp();
    ...
    public void verifyRatingSystemTV_G() {
        ratingsSetup(TV_G.getContentRating(), getCountry());
        handleOneTrustPopUp();
    ...
    public void verifyRatingSystemTV_PG() {
        ratingsSetup(TV_PG.getContentRating(), getCountry());
        handleOneTrustPopUp();
    ...
    public void verifyRatingSystemPG_13() {
        ratingsSetup(PG_13.getContentRating(), getCountry());
        handleOneTrustPopUp();
    ...
    public void verifyRatingSystemTV_14() {
        ratingsSetup(TV_14.getContentRating(), getCountry());
        handleOneTrustPopUp();
    ...
    public void verifyRatingSystemR() {
        ratingsSetup(RatingConstant.Rating.RESTRICTED.getContentRating(), getCountry());
        handleOneTrustPopUp();
    ...
    public void verifyRatingSystemTV_MA() {
        ratingsSetup(TV_MA.getContentRating(), getCountry());
        handleOneTrustPopUp();
