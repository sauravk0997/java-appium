...
public class DisneyPlusAppleTVSettingsTests extends DisneyPlusAppleTVBaseTest {
    ...
    public void verifyLegalPage() {
        ...
        sa.assertTrue(legalPage.getSubscriberAgreement().isPresent(),
                "Subscriber Agreement option is not present");
        sa.assertTrue(legalPage.getPrivacyPolicy().isPresent(),
                "Privacy Policy option is not present");
        sa.assertTrue(legalPage.getUSPrivacyRights().isPresent(),
                "US Privacy Rights option is not present");
