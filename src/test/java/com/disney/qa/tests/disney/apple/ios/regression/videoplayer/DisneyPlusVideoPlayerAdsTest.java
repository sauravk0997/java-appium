...
public class DisneyPlusVideoPlayerAdsTest extends DisneyBaseTest {
    ...
    @Test(description = "VOD Player - Ads - Ad Duration Timer - Controls UP & DOWN (VOD)", groups = {TestGroup.VIDEOPLAYERADS, TestGroup.PRE_CONFIGURATION})
    ...
    @Test(description = "Ariel Ads Video Player > In Ad, Audio Subtitle button displayed/clickable", groups = {TestGroup.VIDEOPLAYERADS, TestGroup.PRE_CONFIGURATION})
    ...
    @Test(description = "Ariel Ads Video Player > Able to scrub forward during Grace period", groups = {TestGroup.VIDEOPLAYERADS, TestGroup.PRE_CONFIGURATION})
    ...
    @Test(description = "VOD Player - Ads - Restart - Restart Button inactive during Pre-Roll Ad", groups = {TestGroup.VIDEOPLAYERADS, TestGroup.PRE_CONFIGURATION})
    ...
    @Test(description = "VOD Player - Ads - Display of Ad Badge", groups = {TestGroup.VIDEOPLAYERADS, TestGroup.PRE_CONFIGURATION})
    ...
    @Test(description = "VOD Player - Ads - No Skip Forward or Backward allowed", groups = {TestGroup.VIDEOPLAYERADS, TestGroup.PRE_CONFIGURATION})
    ...
    @Test(description = "VOD Player - Ads - Leave Player during Ad", dataProvider = "content", groups = {TestGroup.VIDEOPLAYERADS, TestGroup.PRE_CONFIGURATION})
    ...
    @Test(description = "Ariel Ads Video Player > Scrub forward after grace period", groups = {TestGroup.VIDEOPLAYERADS, TestGroup.PRE_CONFIGURATION})
    ...
    @Test(description = "Ariel - VOD Player - Ads - Duration of VOD stream should only include main content", groups = {TestGroup.VIDEOPLAYERADS, TestGroup.PRE_CONFIGURATION})
    ...
    @Test(description = "Ariel - VOD Player - Ads - Ad Content Time Display", groups = {TestGroup.VIDEOPLAYERADS, TestGroup.PRE_CONFIGURATION})
    ...
    @Test(description = "Ariel - VOD Player - Ads - Content Rating Displayed after Pre-roll", groups = {TestGroup.VIDEOPLAYERADS, TestGroup.PRE_CONFIGURATION})
    ...
    @Test(description = "Ariel - VOD Player - Ad PreRoll Only Plays Once At Start of Playback", groups = {TestGroup.VIDEOPLAYERADS, TestGroup.PRE_CONFIGURATION})
