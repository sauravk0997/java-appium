...
public class WebAudioTestsEvent extends bamHlsBaseTest {
    ...
    public void baseEvent() {
        ...
        mA.newSession(BamHlsParameter.BAMHLS_MASTER_URL.getValue(), 1920, 1080, 5);
    ...
    //Disabled until implemented in Version 5.2
    @QTestCases(id = "549")
    @Test(description = "Media - Confirm video can be started with non-default language", priority = 2, enabled = false)
