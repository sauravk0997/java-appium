package com.disney.qa.tests.bamHls.master.vod;
...
public class WebAdvancedPlaybackTestsVod extends bamHlsBaseTest {
    ...
    @QTestCases(id = "620")
    @Test(description = "Player - Seek multiple times forward", priority = 4)
    ...
    @QTestCases(id = "672")
    @Test(description = "Player - Playback rates greater than 1x revert to 1x when end of buffer is reached", priority = 7, enabled = false)
