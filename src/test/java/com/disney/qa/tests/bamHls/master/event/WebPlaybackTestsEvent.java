...
public class WebPlaybackTestsEvent extends bamHlsBaseTest {
    ...
    @QTestCases(id ="521")
    @Test(description = "Confirm Media is PLAYING", priority = 1)
    ...
    @QTestCases(id ="522")
    @Test(description = "Confirm Media is PAUSED", priority = 2)
    ...
    @QTestCases(id ="523")
    @Test(description = "Confirm Media to RESUME after PAUSE", priority = 3)
