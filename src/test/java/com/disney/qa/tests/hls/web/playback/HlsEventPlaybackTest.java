...
public class HlsEventPlaybackTest extends HlsBaseTest{
    ...
    public void testPlayMediaPlayer() {
        ...
        hP.hlsHelperTestPlayUrl(HlsPlayerPlaybackHelper.TEST_URL_EVENT);
    ...
    public void testCompletedEvent() {
        ...
        if ("ie".equalsIgnoreCase(Configuration.get(Parameter.BROWSER))) {
            hP.hlsHelperTestPlayUrl(HlsPlayerPlaybackHelper.TEST_URL_EVENT_OFFSET_IE);
            hP.hlsHelperWaitForVideoToEnd();
        } else {
            hP.hlsHelperTestPlayUrl(HlsPlayerPlaybackHelper.TEST_URL_EVENT_OFFSET);
            hP.hlsHelperWaitForVideoToEnd();
        }
