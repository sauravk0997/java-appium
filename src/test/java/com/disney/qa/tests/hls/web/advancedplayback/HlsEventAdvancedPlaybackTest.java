...
public class HlsEventAdvancedPlaybackTest extends HlsBaseTest{
    ...
    public void increasePlayerWidth() {
        ...
        hP.hlsHelperPlayerWidthIncrease(HlsPlayerPlaybackHelper.TEST_URL_EVENT);
    ...
    public void decreasePlayerWidth() {
        ...
        hP.hlsHelperPlayerWidthDecrease(HlsPlayerPlaybackHelper.TEST_URL_EVENT);
    ...
    public void setPlaybackRate() {
        for (String rate : HlsPlayerPlaybackHelper.getPlayBackRate()) {
            ...
            hP.hlsHelperSetPlaybackRate(HlsPlayerPlaybackHelper.TEST_URL_EVENT, rate);
    ...
    public void reachMaximumBitrate() {
        ...
        Object maxBitRate = hP.hlsHelperPlayerReachMaxBitrate(HlsPlayerPlaybackHelper.TEST_URL_EVENT, "1546");
    ...
    public void noBitrateDropOnSeek() {
        ...
        Object noBitrateDropOnSeek = hP.hlsHelperNoBitrateDropOnSeek(HlsPlayerPlaybackHelper.TEST_URL_EVENT, "1546");
    ...
    public void seekFutureSeekPast() {
        ...
        Object testResult = hP.hlsHelperPlayerSeekFutureSeekPast(HlsPlayerPlaybackHelper.TEST_URL_EVENT);
    ...
    public void seekForwardMultipleTimes() {
        ...
        Object testResult = hP.hlsHelperPlayerSeekForwardMultipleTimes(HlsPlayerPlaybackHelper.TEST_URL_EVENT);
    ...
    public void seekBackwardMultipleTimes() {
        ...
        Object testResult = hP.hlsHelperPlayerSeekBackwardMultipleTimes(HlsPlayerPlaybackHelper.TEST_URL_EVENT);
    ...
    public void seekBackwardMultipleTimesFromTail() {
        ...
        Object testResult = hP.hlsHelperPlayerSeekBackwardMultipleTimesFromTail(HlsPlayerPlaybackHelper.TEST_URL_EVENT_OFFSET);
