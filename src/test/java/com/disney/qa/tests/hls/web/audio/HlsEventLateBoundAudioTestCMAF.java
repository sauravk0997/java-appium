...
public class HlsEventLateBoundAudioTestCMAF extends HlsBaseTest {
    ...
    public void testConfirmAudioFeeds() {
        ...
        hP.hlsLateBoundConfirmAudioFeeds(HlsPlayerLateBoundAudioHelper.TEST_URL_CMAF_URL_EVENT_UNENC);
    ...
    public void testConfirmNonDefaultLanguage() {
        ...
        hP.hlsConfirmAudioFeedSetLanguage(HlsPlayerLateBoundAudioHelper.TEST_URL_CMAF_URL_EVENT_UNENC,"sp");
    ...
    public void testConfirmLanguageChange() {
        ...
        hP.hlsConfirmLanguageChange(HlsPlayerLateBoundAudioHelper.TEST_URL_CMAF_URL_EVENT_UNENC, "sp");
    ...
    public void testConfirmLateBoundAudioChangeName() {
        ...
        hP.hlsConfirmLanguageNamePlayback(HlsPlayerLateBoundAudioHelper.TEST_URL_CMAF_URL_EVENT_UNENC, "Alt");
