...
public class HlsSlidePlaybackTestDrmCbcsSilk extends HlsBaseTest{
    ...
    public void testPlayMediaPlayer() {
        ...
        hP.hlsHelperTestPlayUrl(HlsPlayerPlaybackHelper.TEST_URL_CBCS_SILK_URL_SLIDE);
    ...
    public void testCompletedEventSlide() {
        ...
        hP.hlsHelperTestPlayUrl(HlsPlayerPlaybackHelper.TEST_URL_CBCS_SILK_URL_SLIDE_OFFSET);
