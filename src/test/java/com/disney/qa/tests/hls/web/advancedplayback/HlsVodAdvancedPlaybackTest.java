...
public class HlsVodAdvancedPlaybackTest extends HlsBaseTest{
    ...
    public void increasePlayerWidth() {
        ...
        hP.hlsHelperPlayerWidthIncrease(HlsPlayerPlaybackHelper.TEST_URL_VOD);
    ...
    public void decreasePlayerWidth() {
        ...
        hP.hlsHelperPlayerWidthDecrease(HlsPlayerPlaybackHelper.TEST_URL_VOD);
    ...
    public void setPlaybackRate() {
        for (String rate : HlsPlayerPlaybackHelper.getPlayBackRate()) {
            ...
            hP.hlsHelperSetPlaybackRate(HlsPlayerPlaybackHelper.TEST_URL_VOD, rate);
    ...
    public void reachMaximumBitrate() {
        ...
        Object maxBitRate = hP.hlsHelperPlayerReachMaxBitrate(HlsPlayerPlaybackHelper.TEST_URL_VOD, "1546");
    ...
    public void noBitrateDropOnSeek() {
        ...
        Object noBitrateDropOnSeek = hP.hlsHelperNoBitrateDropOnSeek(HlsPlayerPlaybackHelper.TEST_URL_VOD,"1546");
    ...
    public void seekFutureSeekPast() {
        ...
        Object testResult = hP.hlsHelperPlayerSeekFutureSeekPast(HlsPlayerPlaybackHelper.TEST_URL_VOD);
    ...
    public void seekForwardMultipleTimes() {
        ...
        Object testResult = hP.hlsHelperPlayerSeekForwardMultipleTimes(HlsPlayerPlaybackHelper.TEST_URL_VOD);
    ...
    public void seekBackwardMultipleTimes() {
        ...
        Object testResult = hP.hlsHelperPlayerSeekBackwardMultipleTimes(HlsPlayerPlaybackHelper.TEST_URL_VOD);
    ...
    public void seekBackwardMultipleTimesFromTail() {
        ...
        Object testResult = hP.hlsHelperPlayerSeekBackwardMultipleTimesFromTailVod(HlsPlayerPlaybackHelper.TEST_URL_VOD,1660);
