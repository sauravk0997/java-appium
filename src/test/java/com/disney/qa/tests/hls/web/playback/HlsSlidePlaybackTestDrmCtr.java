...
public class HlsSlidePlaybackTestDrmCtr extends HlsBaseTest{
    ...
    public void testPlayMediaPlayer() {
        ...
        hP.hlsHelperTestPlayUrl(HlsPlayerPlaybackHelper.TEST_URL_CTR_URL_SLIDE);
    ...
    public void testCompletedEventSlide() {
        ...
        hP.hlsHelperTestPlayUrl(HlsPlayerPlaybackHelper.TEST_URL_CTR_URL_SLIDE_OFFSET);
