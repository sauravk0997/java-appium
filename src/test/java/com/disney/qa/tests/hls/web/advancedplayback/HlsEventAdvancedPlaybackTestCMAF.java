...
public class HlsEventAdvancedPlaybackTestCMAF extends HlsBaseTest{
    ...
    public void increasePlayerWidth() {
        ...
        hP.hlsHelperPlayerWidthIncrease(HlsPlayerPlaybackHelper.TEST_URL_CMAF_URL_EVENT_UNENC);
    ...
    public void decreasePlayerWidth() {
        ...
        hP.hlsHelperPlayerWidthDecrease(HlsPlayerPlaybackHelper.TEST_URL_CMAF_URL_EVENT_UNENC);
    ...
    public void setPlaybackRate() {
        for (String rate : HlsPlayerPlaybackHelper.getPlayBackRate()) {
            ...
            hP.hlsHelperSetPlaybackRate(HlsPlayerPlaybackHelper.TEST_URL_CMAF_URL_EVENT_UNENC, rate);
    ...
    public void noBitrateDropOnSeek() {
        ...
        Object noBitrateDropOnSeek = hP.hlsHelperNoBitrateDropOnSeek(HlsPlayerPlaybackHelper.TEST_URL_CMAF_URL_EVENT_UNENC,"2515");
    ...
    public void seekFutureSeekPast() {
        ...
        Object testResult = hP.hlsHelperPlayerSeekFutureSeekPast(HlsPlayerPlaybackHelper.TEST_URL_CMAF_URL_EVENT_UNENC);
    ...
    public void seekForwardMultipleTimes() {
        ...
        Object testResult = hP.hlsHelperPlayerSeekForwardMultipleTimes(HlsPlayerPlaybackHelper.TEST_URL_CMAF_URL_EVENT_UNENC);
    ...
    public void seekBackwardMultipleTimes() {
        ...
        Object testResult = hP.hlsHelperPlayerSeekBackwardMultipleTimes(HlsPlayerPlaybackHelper.TEST_URL_CMAF_URL_EVENT_UNENC);
    ...
    public void seekBackwardMultipleTimesFromTail() {
        ...
        Object testResult = hP.hlsHelperPlayerSeekBackwardMultipleTimesFromTail(HlsPlayerPlaybackHelper.TEST_URL_CMAF_URL_EVENT_UNENC_OFFSET);
