...
import com.disney.qa.hls.utilities.HlsParameterSilk;
...
public class HlsVodPlaybackTestDrmCbcsSilk extends HlsBaseTest {
    ...
    public void baseEvent() {
        ...
        hP.newSession(HlsParameterSilk.HLS_DEV_MASTER_SILK_URL.getValue());
    ...
    public void testPlayMediaPlayer() {
        ...
        hP.hlsHelperTestPlayUrl(HlsPlayerPlaybackHelper.TEST_URL_CBCS_SILK_URL_VOD);
    ...
    public void testConfirmOffsetSeconds() {
        ...
        hP.hlsHelperConfirmOffsetSeconds(HlsPlayerPlaybackHelper.TEST_URL_CBCS_SILK_URL_VOD, 60);
    ...
    public void testConfirmOffsetDate() {
        ...
        hP.hlsHelperConfirmOffsetDate(HlsPlayerPlaybackHelper.TEST_URL_CBCS_SILK_URL_VOD, "2018-05-07T00:01:00.000+00:00");
    ...
    public void testConfirmSeekSeconds() {
        ...
        hP.hlsHelperConfirmSeekSeconds(HlsPlayerPlaybackHelper.TEST_URL_CBCS_SILK_URL_VOD, 60);
    ...
    public void testConfirmSeekDate() {
        ...
        hP.hlsHelperConfirmSeekDate(HlsPlayerPlaybackHelper.TEST_URL_CBCS_SILK_URL_VOD, "2018-05-07T00:01:00.000+00:00");
    ...
    public void testConfirmCompleted() {
        ...
        hP.hlsHelperConfirmOffsetSecondsRun(HlsPlayerPlaybackHelper.TEST_URL_CBCS_SILK_URL_VOD, 670);
