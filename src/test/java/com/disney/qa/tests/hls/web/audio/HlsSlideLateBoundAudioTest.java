...
public class HlsSlideLateBoundAudioTest extends HlsBaseTest {
    ...
    public void testConfirmAudioFeeds() {
        ...
        hP.hlsLateBoundConfirmAudioFeeds(HlsPlayerLateBoundAudioHelper.TEST_URL_SLIDE);
    ...
    public void testConfirmNonDefaultLanguage() {
        ...
        hP.hlsConfirmAudioFeedSetLanguage(HlsPlayerLateBoundAudioHelper.TEST_URL_SLIDE,"rus");
    ...
    public void testConfirmLanguageChangeRus() {
        SoftAssert sa = new SoftAssert();

        hP.hlsConfirmLanguageChange(HlsPlayerLateBoundAudioHelper.TEST_URL_SLIDE, "rus");

        LOGGER.info("Confirming Language Change...");
    ...
    public void testConfirmLateBoundAudioChangeName() {
        ...
        hP.hlsConfirmLanguageNamePlayback(HlsPlayerLateBoundAudioHelper.TEST_URL_SLIDE, "Español (fox deportes)");
