...
public class HlsEventPlaybackTestDrmCtrSilk extends HlsBaseTest{
    ...
    public void testPlayMediaPlayer() {
        ...
        hP.hlsHelperTestPlayUrl(HlsPlayerPlaybackHelper.TEST_URL_CTR_SILK_URL_EVENT);
     ...
     public void testCompletedEventSlide() {
         ...
         hP.hlsHelperTestPlayUrl(HlsPlayerPlaybackHelper.TEST_URL_CTR_SILK_URL_EVENT_OFFSET);
