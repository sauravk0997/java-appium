...
public class HlsVodLateBoundAudioTestCMAF extends HlsBaseTest {
    ...
    public void testConfirmAudioFeeds() {
        ...
        hP.hlsLateBoundConfirmAudioFeeds(HlsPlayerLateBoundAudioHelper.TEST_URL_CMAF_URL_VOD_UNENC);
    ...
    public void testConfirmNonDefaultLanguage() {
        ...
        hP.hlsConfirmAudioFeedSetLanguage(HlsPlayerLateBoundAudioHelper.TEST_URL_CMAF_URL_VOD_UNENC,"sp");
    ...
    public void testConfirmLanguageChange() {
        ...
        hP.hlsConfirmLanguageChange(HlsPlayerLateBoundAudioHelper.TEST_URL_CMAF_URL_VOD_UNENC, "sp");
    ...
    public void testConfirmLateBoundAudioChangeName() {
        ...
        hP.hlsConfirmLanguageNamePlayback(HlsPlayerLateBoundAudioHelper.TEST_URL_CMAF_URL_VOD_UNENC, "Alt");
