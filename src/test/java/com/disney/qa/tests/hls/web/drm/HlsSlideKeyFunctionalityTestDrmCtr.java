...
public class HlsSlideKeyFunctionalityTestDrmCtr extends HlsBaseTest {
    ...
    public void keyRotationFastFail() {
        ...
        Object testResult = hP.hlsHelperPlayerKeyRotationFastFail(HlsPlayerPlaybackHelper.TEST_URL_CTR_URL_SLIDE_KR);
    ...
    public void keyRotationPlayThroughChange() {
        ...
        Object testResult = hP.hlsHelperPlayerKeyRotationPlayThroughChange(HlsPlayerPlaybackHelper.TEST_URL_CTR_URL_SLIDE_KR);
    ...
    public void keyRotationPlayThroughChangeAndSeekBack() {
        ...
        Object testResult = hP.hlsHelperPlayerKeyRotationPlayThroughChangeAndSeekBack(HlsPlayerPlaybackHelper.TEST_URL_CTR_URL_SLIDE_KR);
