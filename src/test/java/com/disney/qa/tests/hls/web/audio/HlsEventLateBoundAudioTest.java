...
public class HlsEventLateBoundAudioTest extends HlsBaseTest {
    ...
    public void testConfirmAudioFeeds() {
        ...
        hP.hlsLateBoundConfirmAudioFeeds(HlsPlayerLateBoundAudioHelper.TEST_URL_EVENT);
    ...
    public void testConfirmNonDefaultLanguageRus() {
        SoftAssert sa = new SoftAssert();

        hP.hlsConfirmAudioFeedSetLanguage(HlsPlayerLateBoundAudioHelper.TEST_URL_EVENT,"rus");
    ...
    public void testConfirmLanguageChange() {
        ...
        hP.hlsConfirmLanguageChange(HlsPlayerLateBoundAudioHelper.TEST_URL_EVENT, "rus");
    ...
    public void testConfirmLanguageChangeEsp() {
        SoftAssert sa = new SoftAssert();

        hP.hlsConfirmLanguageNamePlayback(HlsPlayerLateBoundAudioHelper.TEST_URL_EVENT, "Español (fox deportes)");
