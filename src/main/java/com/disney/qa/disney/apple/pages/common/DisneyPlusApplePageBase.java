...
public class DisneyPlusApplePageBase extends DisneyAbstractPage implements IRemoteControllerAppleTV, IOSUtils, IAPIHelper {
    ...
    public void moveDownUntilCollectionContentIsFocused(String collectionName, int count) {
        ...
        LOGGER.info("Collection ID:- " + getFirstCellFromCollection(collectionName));
        ...
        while (count > 0) {
            moveDown(1, 1);
            LOGGER.info("Collection Focused:- " + getFirstCellFromCollection(collectionName).getAttribute("focused"));
            LOGGER.info("Collection Focused:- " + firstCellFromCollection.isPresent(ONE_SEC_TIMEOUT));
