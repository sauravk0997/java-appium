...
public class DisneyPlusEdnaDOBCollectionPageBase extends DisneyPlusApplePageBase {
    ...
    public boolean isOpened() {
        String ednaDateOfBirthPageTitle = iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.IDENTITY,
    ...
    public boolean isEdnaDateOfBirthDescriptionPresent() {
        String ednaDateOfBirthPageDescription = iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.IDENTITY,
    ...
    public boolean isEdnaBirthdateLabelDisplayed() {
        String birthdateLabel = iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.IDENTITY,
    ...
    public boolean isEdnaDateOfBirthFormatErrorPresent() {
        String ednaDateOfBirthFormatError = iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.IDENTITY,
    ...
    public boolean isLogOutBtnDisplayed() {
        String logOutButton = iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.IDENTITY,
    ...
    public void tapSaveAndContinueButton() {
        String enforceDateOfBirthLogOutButton = iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.IDENTITY,
