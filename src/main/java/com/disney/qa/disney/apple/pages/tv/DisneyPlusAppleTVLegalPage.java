...
public class DisneyPlusAppleTVLegalPage extends DisneyPlusApplePageBase {
    ...
    private ExtendedWebElement NoticeOfRightToOptOutOfSaleSharingButton;

    @ExtendedFindBy(iosClassChain = "**/XCUIElementTypeStaticText[`label == \"Notice of Right to Opt Out of Sale/Sharing\"`][2]")
    private ExtendedWebElement NoticeOfRightToOptOutOfSaleSharingTitle;
    ...
    private ExtendedWebElement SellingSharingTargetedAdvertisingContent1;
    ...
    private ExtendedWebElement SellingSharingTargetedAdvertisingContent2;
    ...
    private ExtendedWebElement SellingSharingTargetedAdvertisingContent3;
    ...
    private ExtendedWebElement SellingSharingTargetedAdvertisingContent4;
    ...
    private ExtendedWebElement SellingSharingTargetedAdvertisingContent5;
    ...
    private ExtendedWebElement SellingSharingTargetedAdvertisingContent6;
    ...
    public void areAllLegalDocumentsPresentAndScrollable(String siteConfig, SoftAssert sa, DisneyContentApiChecker apiChecker) {
        ...
        IntStream.range(0, labels.size()).forEach(i -> {
            ...
            if (i != 3) {
                ...
                clickSelect();
                Screenshot.capture(getDriver(), ScreenshotType.EXPLICIT_VISIBLE);
                sa.assertTrue(NoticeOfRightToOptOutOfSaleSharingButton.isPresent(),"Notice of Right to Opt Out of Sale/Sharing Button is not been displayed");
                sa.assertTrue(NoticeOfRightToOptOutOfSaleSharingTitle.isPresent(),"Notice of Right to Opt Out of Sale/Sharing Title is not been displayed");
                sa.assertTrue(NoticeOfRightToOptOutOfSaleSharingContent.isPresent(),"Notice of Right to Opt Out of Sale/Sharing Content is not been displayed");

                moveDown(1,1);
                moveRight(1,1);
                sa.assertTrue(SellingSharingTargetedAdvertisingButton.isPresent(),"Selling, Sharing, Targeted Advertising Button is not been displayed");
                sa.assertTrue(SellingSharingTargetedAdvertisingTitle.isPresent(),"Selling, Sharing, Targeted Advertising Title is not been displayed");
                sa.assertTrue(SellingSharingTargetedAdvertisingCheckboxLabel.isPresent(),"Selling, Sharing, Targeted Advertising Checkbox label is not been displayed");
                sa.assertTrue(SellingSharingTargetedAdvertisingContent1.isPresent(),"Selling, Sharing, Targeted Advertising Content paragraph 1 is not been displayed");
                sa.assertTrue(SellingSharingTargetedAdvertisingContent2.isPresent(),"Selling, Sharing, Targeted Advertising Content paragraph 2 is not been displayed");
                sa.assertTrue(SellingSharingTargetedAdvertisingContent3.isPresent(),"Selling, Sharing, Targeted Advertising Content paragraph 3 is not been displayed");
                moveDown(6,1);
                sa.assertTrue(SellingSharingTargetedAdvertisingContent4.isPresent(),"Selling, Sharing, Targeted Advertising Content paragraph 4 is not been displayed");
                sa.assertTrue(SellingSharingTargetedAdvertisingContent5.isPresent(),"Selling, Sharing, Targeted Advertising Content paragraph 5 is not been displayed");
                sa.assertTrue(SellingSharingTargetedAdvertisingContent6.isPresent(),"Selling, Sharing, Targeted Advertising Content paragraph 6 is not been displayed");
