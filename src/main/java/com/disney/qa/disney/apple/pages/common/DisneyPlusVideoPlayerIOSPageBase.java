...
public class DisneyPlusVideoPlayerIOSPageBase extends DisneyPlusApplePageBase {
    ...
    public ExtendedWebElement getAdRemainingTime() {
        ...
        fluentWait(getDriver(), DELAY, ONE_SEC_TIMEOUT, "Ad not displayed").until(it -> adRemainingTime.isPresent());
    ...
    public void waitForR21PauseTimeOutToComplete(int waitTime, int polling) {
