...
public class DisneyPlusVideoPlayerIOSPageBase extends DisneyPlusApplePageBase {
    ...
    public ExtendedWebElement getAdRemainingTime() {
        ...
        fluentWait(getDriver(), TWENTY_FIVE_SEC_TIMEOUT, FIVE_SEC_TIMEOUT,
                "Ad not displayed").until(it -> adRemainingTime.isPresent());
    ...
    public int getAdRemainingTimeInSeconds() {
        waitUntil(ExpectedConditions.visibilityOfElementLocated(staticTextLabelContains.format(":").getBy()), 20);
