...
public class DisneyPlusDetailsIOSPageBase extends DisneyPlusApplePageBase {
    ...
    public ExtendedWebElement getRemoveFromWatchListButton() {
        return getTypeButtonByLabel(getDictionary().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.ACCESSIBILITY,
    ...
    public ExtendedWebElement getTrailerButton() {
        return getTypeButtonContainsLabel(getDictionary().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION,
                DictionaryKeys.ACTION_BTN_TRAILER.getText()));
    }
