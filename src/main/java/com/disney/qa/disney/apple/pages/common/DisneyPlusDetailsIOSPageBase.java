...
public class DisneyPlusDetailsIOSPageBase extends DisneyPlusApplePageBase {
    ...
    private final ExtendedWebElement episodesTab = dynamicBtnFindByLabel.format(iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION, DictionaryKeys.NAV_EPISODES.getText()));
    ...
    private final ExtendedWebElement stopOrPauseDownloadButton = getDynamicRowButtonLabel(
            iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.ACCESSIBILITY,
    ...
    public void clickSeasonsButton(String season) {
        ...
        String seasonsButton = iapiHelper.getLocalizationUtils().formatPlaceholderString(iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION, DictionaryKeys.BTN_SEASON_NUMBER.getText()), Map.of(SEASON_NUMBER, season));
    ...
    public List<ExtendedWebElement> getSeasonsFromPicker() {
        String season = iapiHelper.getLocalizationUtils().formatPlaceholderString(iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION, DictionaryKeys.BTN_SEASON_NUMBER.getText()), Map.of(SEASON_NUMBER, ""));
    ...
    public boolean isTwentyDownloadsTextDisplayed() {
        Screenshot.capture(getDriver(), ScreenshotType.EXPLICIT_VISIBLE);
        String twentyDownloadsText = iapiHelper.getLocalizationUtils().formatPlaceholderString(iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION,
    ...
    public ExtendedWebElement getRemoveFromWatchListButton() {
        return getTypeButtonByLabel(iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.ACCESSIBILITY,
    ...
    public ExtendedWebElement getTrailerButton() {
        return getTypeButtonContainsLabel(iapiHelper.getLocalizationUtils().getDictionaryItem(
    ...
    public boolean doesOneOrMoreSeasonDisplayed() {
        ...
        String[] seasonsText = iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION, DictionaryKeys.DETAILS_TOTAL_SEASON.getText()).split(" ");
        if (!getParsedString(metaDataLabel, "1", ",").contains("Seasons")) {
            ...
            String multiSeason = iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION, DictionaryKeys.DETAILS_TOTAL_SEASONS.getText());
            multiSeason = iapiHelper.getLocalizationUtils().formatPlaceholderString(multiSeason, Map.of("number_of_seasons", Integer.parseInt(numberOfSeasons)));
    ...
    public ExtendedWebElement getDetailsTab() {
        return getTypeButtonContainsLabel(iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION, DictionaryKeys.NAV_DETAILS.getText()));
    }
    ...
    public ExtendedWebElement getPlayButton() {
        return getStaticTextByLabel(iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION,
                BTN_PLAY.getText()));
    }
    ...
    public ExtendedWebElement getTrailerActionButton() {
        return dynamicBtnFindByLabel.format(iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION,
                BTN_TRAILER.getText()));
    }
    ...
    public ExtendedWebElement getUpcomingDateTime() {
        ...
        String upcomingDateAndTime = iapiHelper.getLocalizationUtils().formatPlaceholderString(iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.ACCESSIBILITY,
    ...
    public ExtendedWebElement getUpcomingBadge() {
        String upcomingBadge = iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.ACCESSIBILITY, BADGE_LABEL_EVENT_UPCOMING.getText());
        return getStaticTextByLabel(upcomingBadge);
    }

    public ExtendedWebElement getUpcomingTodayBadge() {
        String upcomingTodayBadge = iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.ACCESSIBILITY, BADGE_LABEL_EVENT_UPCOMING_TODAY.getText());
    ...
    public String getDetailsTabSeasonRating() {
        ...
        return iapiHelper.getLocalizationUtils().formatPlaceholderString(iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION,
    ...
    public ExtendedWebElement getHuluContinueButton() {
        return getTypeButtonByName(iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION, BTN_CONTINUE.getText()));
    }
    ...
    public boolean isNegativeStereotypeAdvisoryLabelPresent() {
        String contentAdvisoryText = String.format("%s, %s ",
                iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION, DETAILS_CONTENT_ADVISORY_TITLE.getText()),
                iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION, DETAILS_NEGATIVE_STEREOTYPE_ADVISORY.getText()).trim()).replaceAll("\\s+", " ");
    ...
    public ExtendedWebElement getRatingRestrictionDetailMessage() {
        String upcomingBadge = iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.PCON, RATING_RESTRICTION_DETAIL_MESSAGE.getText());
        return getStaticTextByLabel(upcomingBadge);
    }
    ...
    public boolean isIMAXEnhancedTitlePresentInVersionTab() {
        String[] iMaxEnhancedTitle = iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION, DictionaryKeys.DETAILS_VERSIONS_IMAX_ENHANCED_TITLE.getText()).split("-");
    ...
    public boolean isIMAXEnhancedDescriptionPresentInVersionTab() {
        String iMaxEnhancedDescription = iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION, DictionaryKeys.DETAILS_VERSIONS_IMAX_ENHANCED_DESCRIPTION.getText());
    ...
    public ExtendedWebElement getContinueWatchingTimeRemaining() {
        String continueWatchingHours = iapiHelper.getLocalizationUtils().formatPlaceholderString(iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION, CONTINUE_WATCHING_HOURS.getText()),
    ...
    public void validateRatingsInDetailsTab(String rating, SoftAssert sa) {
        ...
        if (R.CONFIG.get(DEVICE_TYPE).equals(PHONE)) {
            swipe(getTypeOtherByLabel(iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION, DETAILS_RATING.getText())), 2);
        }
    ...
    public ExtendedWebElement getDownloadModalPlayButton() {
        String play = iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION,
    ...
    public boolean isDownloadModalRenewButtonDisplayed() {
        String renew = iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION,
    ...
    public boolean isDownloadModalRemoveButtonDisplayed() {
        String remove = iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION,
    ...
    public boolean isDownloadSeasonButtonDisplayed(String seasonNumber) {
        return getTypeButtonByLabel(iapiHelper.getLocalizationUtils().formatPlaceholderString(
    ...
    public boolean isDownloadInProgressStatusDisplayed() {
        String downLoadInProgress = iapiHelper.getLocalizationUtils().getValuesBetweenPlaceholders(iapiHelper.getLocalizationUtils().
    ...
    public boolean isPauseDownloadButtonDisplayed() {
        int count = 5;
        ExtendedWebElement pauseDownloadButton = getTypeButtonByLabel(iapiHelper.getLocalizationUtils().
                getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION,
    ...
    public boolean isRemoveDownloadButtonDisplayed() {
        return getTypeButtonByLabel(iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION,
    ...
    public ExtendedWebElement getEpisodeTitleFromEpisodsTab(String season, String episodeTitle) {
        return getStaticTextByLabel(iapiHelper.getLocalizationUtils().formatPlaceholderString(iapiHelper.getLocalizationUtils()
                        .getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION,
