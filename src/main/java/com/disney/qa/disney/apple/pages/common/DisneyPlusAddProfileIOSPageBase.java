...
public class DisneyPlusAddProfileIOSPageBase extends DisneyPlusApplePageBase {
    ...
    private ExtendedWebElement kidsOnToggleButton = typeCellLabelContains.format(
            getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION,
                    DictionaryKeys.TOGGLE_ON.getText()));
    ...
    public ExtendedWebElement getSecureProfilePINTitle() {
        return staticTextByLabel.format(getLocalizationUtils().getDictionaryItem(
                DisneyDictionaryApi.ResourceKeys.WELCH, DictionaryKeys.SECURE_PROFILE_PIN_TITLE.getText()));
    }
