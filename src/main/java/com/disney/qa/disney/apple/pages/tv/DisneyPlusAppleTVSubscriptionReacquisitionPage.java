...
public class DisneyPlusAppleTVSubscriptionReacquisitionPage extends DisneyPlusSubscriptionReacquisitionIOSPageBase {
    ...
    private ExtendedWebElement joinNowButton = dynamicBtnFindByLabel.format(getAppleTVLocalizationUtils().getDictionaryItem(
            DisneyDictionaryApi.ResourceKeys.UNIFIED_COMMERCE_ONBOARDING,
            DictionaryKeys.DEVICE_BTN_JOIN_NOW.getText()));

    private ExtendedWebElement logOutButton = dynamicBtnFindByLabel.format(getAppleTVLocalizationUtils().getDictionaryItem(
            DisneyDictionaryApi.ResourceKeys.UNIFIED_COMMERCE_ONBOARDING,
