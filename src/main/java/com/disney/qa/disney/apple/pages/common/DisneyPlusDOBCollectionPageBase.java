...
public class DisneyPlusDOBCollectionPageBase extends DisneyPlusApplePageBase {
    ...
    protected ExtendedWebElement dateOfBirthHeader = getStaticTextByLabel(iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION, DictionaryKeys.DATE_OF_BIRTH_TITLE.getText()));
    //FUNCTIONS
