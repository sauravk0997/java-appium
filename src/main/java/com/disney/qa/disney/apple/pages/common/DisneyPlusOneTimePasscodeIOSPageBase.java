...
public class DisneyPlusOneTimePasscodeIOSPageBase extends DisneyPlusApplePageBase {
    ...
    private ExtendedWebElement resendButton = xpathNameOrName.format(iapiHelper.getLocalizationUtils()
    ...
    public void enterOtpValue(String value) {
        ...
        getStaticTextByLabel(iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.IDENTITY, DictionaryKeys.MY_DISNEY_CONTINUE_BTN.getText())).click();
    }
