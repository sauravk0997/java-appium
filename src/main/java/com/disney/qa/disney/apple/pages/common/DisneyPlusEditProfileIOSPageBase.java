...
public class DisneyPlusEditProfileIOSPageBase extends DisneyPlusAddProfileIOSPageBase {
    ...
    private final ExtendedWebElement deleteProfileButton = getDynamicAccessibilityId(iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION, BTN_DELETE_PROFILE.getText()));
    private final ExtendedWebElement editProfileTitle = getDynamicAccessibilityId(iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION, DictionaryKeys.EDIT_PROFILE_TITLE.getText()));
    ...
    private final ExtendedWebElement pinSettingsCell = staticTextByLabelOrLabel.format(iapiHelper.getLocalizationUtils()
    ...
    private final ExtendedWebElement contentRatingHeader = getStaticTextByLabel(
            iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.PCON, DictionaryKeys.MATURITY_RATING_SETTINGS_LABEL.getText()));
    ...
    public ExtendedWebElement getDoneButton() {
        String button = iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.PCON, BTN_PROFILE_SETTINGS_DONE.getText());
        return dynamicBtnFindByLabel.format(button);
    }

    private final String genderTitle = iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION, DictionaryKeys.SETTINGS_GENDER.getText());
    ...
    public ExtendedWebElement getSharePlayTooltip() {
        String toastText = iapiHelper.getLocalizationUtils()
    ...
    public boolean verifyProfileSettingsMaturityRating(String rating) {
        String contentRatingText = iapiHelper.getLocalizationUtils().formatPlaceholderString(
    ...
    public boolean isBirthdateHeaderDisplayed() {
        String birthdateHeader = iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION, SETTINGS_DATE_OF_BIRTH.getText());
    ...
    public void selectInfoHyperlink() {
        sharePlayHyperLink.format(iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION,
                DictionaryKeys.GROUPWATCH_SHAREPLAY_SETTINGS_SUBHEADER.getText())).click();
    }

    public ExtendedWebElement getLearnMoreLink() {
        String learnMoreText = iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION, JUNIOR_MODE_LEARN_MORE.getText());
    ...
    public boolean isProfilePinActionDisplayed() {
        return staticTextByLabel.format(iapiHelper.getLocalizationUtils().
    ...
    public boolean isUpdatedToastPresent() {
        return staticTextByLabel.format(iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.PCON, DictionaryKeys.PROFILE_SETTINGS_GENERIC_TOAST.getText())).isPresent();
    }

    public void waitForUpdatedToastToDisappear() {
        ExtendedWebElement updatedToast = staticTextByLabel.format(iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.PCON, DictionaryKeys.PROFILE_SETTINGS_GENERIC_TOAST.getText()));
    ...
    public boolean isEditTitleDisplayed() {
        return staticTextByLabel.format(iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION,
    ...
    public boolean isPlayBackSettingsSectionDisplayed() {
        return staticTextByLabel.format(iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION,
                ...
                staticTextByLabel.format(iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION,
    ...
    public boolean isFeatureSettingsSectionDisplayed() {
        ExtendedWebElement sharePlaySubheader = textViewByLabel.format(iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION,
    ...
    public ExtendedWebElement getJuniorModeDescription() {
        return textViewByLabel.format(iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION,
    ...
    public boolean isErrorDuplicateProfileNamePresent() {
        String message = iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION, ERROR_DUPLICATE_PROFILE_NAME.getText());
    ...
    public ExtendedWebElement getDeleteProfileCancelButton() {
        return getTypeButtonByLabel(iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION, DictionaryKeys.CANCEL_BTN_NORMAL.getText()));
    }

    public ExtendedWebElement getDeleteProfileDeleteButton() {
        return getTypeButtonByLabel(iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION, DictionaryKeys.BTN_DELETE.getText()));
    }

    public ExtendedWebElement getDeleteProfileTitle(String profileName) {
        String deleteProfileTitle = iapiHelper.getLocalizationUtils().formatPlaceholderString(iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION, DictionaryKeys.DELETE_PROFILE_TITLE.getText()), Map.of("user_profile", profileName));
        return getStaticTextByLabel(deleteProfileTitle);
    }

    public ExtendedWebElement getDeleteProfileCopy() {
        return getStaticTextByLabel(iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION, DictionaryKeys.DELETE_PROFILE_COPY.getText()));
    }

    public ExtendedWebElement getEditProfilePinSettingLabel(){
        return getStaticTextByLabel(iapiHelper.getLocalizationUtils()
                .getDictionaryItem(DisneyDictionaryApi.ResourceKeys.PCON,
                        DictionaryKeys.PROFILE_SETTINGS_ENTRY_PIN_LABEL.getText()));
    }
    ...
    public boolean isR21MaturitySliderPresent() {
        ...
        String dictRatingDescription = iapiHelper.getLocalizationUtils()
                .getDictionaryItem(DisneyDictionaryApi.ResourceKeys.PCON,
