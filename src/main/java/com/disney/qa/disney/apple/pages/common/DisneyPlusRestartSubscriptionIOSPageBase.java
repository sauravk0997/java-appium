...
public class DisneyPlusRestartSubscriptionIOSPageBase extends DisneyPlusApplePageBase {
    ...
    private ExtendedWebElement logOutConfirmationButton = dynamicBtnFindByName.format(iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION, BTN_LOGOUT.getText()));
    private ExtendedWebElement logOutCancelButton = dynamicBtnFindByName.format(iapiHelper.getLocalizationUtils().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION, CANCEL_BTN_CAPS.getText()));
