...
public class DisneyPlusAccountOnHoldIOSPageBase extends DisneyPlusApplePageBase {
    ...
    private ExtendedWebElement updatePaymentButton = getTypeButtonByLabel(getDictionary().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION, DictionaryKeys.BTN_ACCOUNT_HOLD_UPDATE_PAYMENT.getText()));
    private ExtendedWebElement refreshButton = getTypeButtonByLabel(getDictionary().getDictionaryItem(DisneyDictionaryApi.ResourceKeys.APPLICATION, DictionaryKeys.BTN_REFRESH.getText()));
