...
public enum DictionaryKeys {
    ...
    MY_DISNEY_ENTER_YOUR_PASSWORD_BODY("mydisney_enter_password_body"),
    MY_DISNEY_ENTER_PASSWORD_HEADER("mydisney_enter_password_header"),
    MY_DISNEY_ENTER_YOUR_PASSWORD_HEADER("mydisney_enter_password_header"),
    MY_DISNEY_ENTER_YOUR_PASSWORD_HINT("mydisney_enter_password_hint"),
