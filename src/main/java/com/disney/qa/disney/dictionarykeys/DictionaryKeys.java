...
public enum DictionaryKeys {
    ...
    CO_ACCOUNT_NO_ENTITLEMENT("co_account_no_entitlement"),
    CO_ACCOUNT_NO_ENTITLEMENT_HEADER("co_account_no_entitlement_header"),
    ...
    CREATE_PROFILE_ADD_PROFILE("create_profile_add_profile"),
    ...
    DETAILS_VERSIONS_DESCRIPTION_IMAX_ENHANCED("details_versions_description_imax_enhanced"),
    DETAILS_VERSIONS_DESCRIPTION_OV_WIDESCREEN("details_versions_description_ov_widescreen"),
    ...
    DOWNLOAD_QUALITY_HIGH_TITLE("download_quality_high_title"),
    DOWNLOAD_QUALITY_HIGH_COPY("download_quality_high_copy"),
    DOWNLOAD_QUALITY_MEDIUM_TITLE("download_quality_medium_title"),
    DOWNLOAD_QUALITY_MEDIUM_COPY("download_quality_medium_copy"),
    DOWNLOAD_QUALITY_STANDARD_TITLE("download_quality_standard_title"),
    DOWNLOAD_QUALITY_STANDARD_COPY("download_quality_standard_copy"),
    ...
    ERROR_ACTIVATION_GENERIC_COPY("error_activation_generic_copy"),
    ...
    LEARN_MORE_CONTENT_RATINGS("learn_more_content_ratings"),
    ...
    OOH_TRAVEL_MODE_MAXED_CTA("ooh_travel_mode_maxed_cta"),
    OOH_TRAVEL_MODE_MAXED_HEADLINE("ooh_travel_mode_maxed_headline"),
    OOH_TRAVEL_MODE_MAXED_SUBCOPY("ooh_travel_mode_maxed_subcopy"),
    ...
    OOH_UPDATE_HOUSEHOLD_MAXED_SUBCOPY("ooh_update_household_maxed_subcopy"),
    OOH_UPDATE_HOUSEHOLD_MAXED_CTA("ooh_travel_mode_maxed_cta"),
    OOH_UPDATE_HOUSEHOLD_MAXED_HEADLINE("ooh_update_household_maxed_headline"),
