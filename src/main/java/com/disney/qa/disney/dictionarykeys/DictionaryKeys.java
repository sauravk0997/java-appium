...
public enum DictionaryKeys {
    ...
    ACCOUNT_SUBSCRIPTION_TITLE_BAMTECH_NOADS("account_subscription_title_bamtech_noads"),
    ...
    BTN_PAUSE_PROFILE_SETTINGS_DONE("btn_profile_settings_done"),
    ...
    DOWNLOAD_QUALITY_HIGH_BODY("download_quality_high_copy"),
    DOWNLOAD_QUALITY_HIGH_TITLE("download_quality_high_title"),
    DOWNLOAD_QUALITY_MEDIUM_BODY("download_quality_medium_copy"),
    DOWNLOAD_QUALITY_MEDIUM_TITLE("download_quality_medium_title"),
    DOWNLOAD_QUALITY_STANDARD_BODY("download_quality_standard_copy"),
    ...
    LOGOUT_ALL_DEVICES_CTA("log_out_all_devices_cta"),
