...
public enum DisneyEntityIds {
    ...
    END_GAME_AVENGERS("Marvel Studios' Avengers: Endgame", "211b146d-13a0-4c71-b2f1-75de907781e9", DisneyEntityIds.PROGRAM_ID),
    DANCING_WITH_THE_STARS("Dancing with the Stars", "38c1eef7-aa8b-4fa4-8bdc-88e596ea565f", DisneyEntityIds.SERIES_ID);
    ...
    DisneyEntityIds(String title, String entityId, String contentType) {
        this.title = title;
